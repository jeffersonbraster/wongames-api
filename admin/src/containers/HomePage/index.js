...
const SOCIAL_LINKS = [
  {
    name: 'GitHub',
    link: 'https://github.com/jeffersonbraster',
  },
  {
    name: 'Slack',
        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
             ...
             <P>Ao lado esquerdo, você pode inserir diversos dados em nossos componentes para customizar a loja!</P>
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              <h2>Veja nossas redes</h2>
              <P style={{ marginTop: 7, marginBottom: 0 }}>Sigam e divulguem nossas redes sociais e fiquem por dentro das novidades</P>
